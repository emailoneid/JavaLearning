...
public class Main {
    ...
    public static void createWeatherDataObject() {
        WeatherData weatherData = new WeatherData("2024-08-01", 28.5, 90);
    ...
    public static void analyzeMultipleDaysWeather() {
        WeatherData[] data = {
                new WeatherData("2024-08-01", 28.5, 90),
                new WeatherData("2024-08-02", 30.0, 70),
                new WeatherData("2024-08-03", 32.0, 65),
        };
